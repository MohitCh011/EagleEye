...
const OngoingProjectsPage = () => {
  ...
  // Fetch ongoing projects from the API
  useEffect(() => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        <p className="text-lg font-bold">Loading ongoing projects...</p>
      </div>
    );
  }
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 py-12">
      <div className="container mx-auto px-6">
        <h1 className="text-3xl font-bold text-center mb-8">Ongoing Projects</h1>
        <motion.div
